...
V1 = L("v1", "CDE_PDE_PIPELINE_GATED_V1.py"); V0 = V1.V0
...
for cid in ids:
    ...
    r1 = V1.decidi(A, b, A2, b2, A3, b3, seme=seme + 7, centers=centers, wx=WX, wt=WT)
    righe.append((cid, atteso, r0["decisione"], r1["decisione"], r1.get("finestre", {}).get("frazione")))
print(f"{'caso':8} {'blind2 corretto':24} {'V0 produzione':24} {'V1':24} sovrapp.")
div0 = div1 = 0
for r in righe:
...
json.dump({"righe": righe, "div_V0": div0, "div_V1": div1}, open(ART / "cde_blind_pde2_out" / "replay_pipeline_V0_V1.json", "w"), indent=1)
