...
CLASSI = "ABCF"; N_PER = 30; SEME_MODELLO = 720_000; SEME_DEGRADO = 730_000
def main():
    ...
    env = {"run": "CDE_BLIND4_GENERATOR_V0", "prereg": PREREG, "prereg_sha256": hashlib.sha256((BASE / PREREG).read_bytes()).hexdigest(),
